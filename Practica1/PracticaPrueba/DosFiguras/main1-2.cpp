...
int main() {
	...
	float vertices[] = {
		...
		0.6f,   -0.9f, 0.0f,  0.247f, 0.968f, 0.113f, //  B
		0.3f,   -0.9f, 0.0f,  0.247f, 0.968f, 0.113f, //  B1
		0.3f,   -0.7f, 0.0f,  0.247f, 0.968f, 0.113f, //  B2
		
		0.3f,   -0.7f, 0.0f,  0.427f, 0.815f, 0.968f, //  B2
		0.49f,  -0.34f, 0.0f, 0.427f, 0.815f, 0.968f, //  B3
		0.49f,  -0.83f, 0.0f, 0.427f, 0.815f, 0.968f, //  B4
		
		0.49f,  -0.34f, 0.0f,  0.960f, 0.513f, 0.129f, //  B3
		0.8f,   -0.6f, 0.0f,   0.960f, 0.513f, 0.129f, //  B5
		0.49f,   -0.6f, 0.0f,  0.960f, 0.513f, 0.129f, //  B6


		0.8f,   -0.6f, 0.0f,   0.811f, 0.819f, 0.823f, //  B5
		0.8f,   -0.7f, 0.0f,   0.811f, 0.819f, 0.823f, //  B8
		0.65f,  -0.6f, 0.0f,   0.811f, 0.819f, 0.823f, //  C

		0.49f,  -0.34f, 0.0f,  0.996f, 0.764f, 0.058f, //  B3
		0.66f,  -0.48f, 0.0f,  0.996f, 0.764f, 0.058f, //  B9
		0.64f,  -0.18f, 0.0f,  0.996f, 0.764f, 0.058f, //  B11

		
		0.66f,  -0.48f, 0.0f,  0.996f, 0.764f, 0.058f, //  B9
		0.8f,   -0.33f, 0.0f,  0.996f, 0.764f, 0.058f, //  B10
		0.64f,  -0.18f, 0.0f,  0.996f, 0.764f, 0.058f, //  B11

		0.64f,  -0.18f, 0.0f,  0.682f, 0.666f, 0.831f, //  B11
		0.6f,  -0.0f, 0.0f,	   0.682f, 0.666f, 0.831f, //  B12
		0.66f,  -0.07f, 0.0f,  0.682f, 0.666f, 0.831f, //  B13
		
		0.64f,  -0.18f, 0.0f,  0.682f, 0.666f, 0.831f, //  B11
		0.6f,  -0.0f, 0.0f,    0.682f, 0.666f, 0.831f, //  B12
		0.57f,  -0.09f, 0.0f,  0.682f, 0.666f, 0.831f, //  B14
		
		//0.8f,   -0.6f, 0.0f,    0.996, 0.764, 0.058, //  B5
		//0.8f,   -0.33f, 0.0f,  0.466f, 0.082f, 0.898f, //  B10
		//0.57f,  -0.09f, 0.0f,  0.466f, 0.082f, 0.898f, //  B14
		0.8f,   -0.33f, 0.0f,  1.0f, 0.0f, 0.0f, //  B10
		0.92f,   -0.33f, 0.0f, 1.0f, 0.0f, 0.0f, //  B15
		0.92f,   -0.2f, 0.0f,  1.0f, 0.0f, 0.0f, //  B16
	};
