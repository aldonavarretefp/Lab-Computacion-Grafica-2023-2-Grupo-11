...
int main() {
	...
	// ponga en true o false la variable isInPerspectiveMode para setear el modo 'Perspectiva'
	bool isInPerspectiveMode = true;
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		if (isInPerspectiveMode) {
			...
			// Usar con la proyección en orto, recibe el numero de unidades en x, y, z en forma de vector
		...
		// Cubo 1
		if (!isInPerspectiveMode) {
			model = glm::scale(model, glm::vec3(50.0f, 50.0f, 50.0f)); // Ocupar en orto
		}
