...
int main() {
 ...
 void Inputs(GLFWwindow *window) {
	 ...
	 if (glfwGetKey(window, GLFW_KEY_LEFT) == GLFW_PRESS)
		 rot -= 0.018f;
	 if (glfwGetKey(window, GLFW_KEY_R) == GLFW_PRESS) // hombro -
		 hombro += 0.18f;
	 if (glfwGetKey(window, GLFW_KEY_F) == GLFW_PRESS) // hombro + 
		 hombro -= 0.18f;
	 if (glfwGetKey(window, GLFW_KEY_T) == GLFW_PRESS) // codo +
		 codo += 0.18f;
	 if (glfwGetKey(window, GLFW_KEY_G) == GLFW_PRESS) // codo -
		 codo -= 0.18f;
	 if (glfwGetKey(window, GLFW_KEY_Y) == GLFW_PRESS) // muñeca +
		 muneca += 0.18f;
	 if (glfwGetKey(window, GLFW_KEY_H) == GLFW_PRESS) // muñeca -
		 muneca -= 0.18f;
	 if (glfwGetKey(window, GLFW_KEY_U) == GLFW_PRESS) // dedo1 +
		 dedo1 += 0.18f;
	 if (glfwGetKey(window, GLFW_KEY_J) == GLFW_PRESS) // dedo1 -
		 dedo1 -= 0.18f;
	 if (glfwGetKey(window, GLFW_KEY_I) == GLFW_PRESS) // dedo2 +
		 dedo2 += 0.18f;
	 if (glfwGetKey(window, GLFW_KEY_K) == GLFW_PRESS) // dedo2 -
		 dedo2 -= 0.18f;
 }
